...
public class WorkersOnST_Form extends javax.swing.JFrame {
    ...
    private JDateChooser finish_sc_st;
    ...
    private JDateChooser start_sc_st;
    private java.awt.TextField textField2;
    // End of variables declaration//GEN-END:variables


    public WorkersOnST_Form(MasterService masterService, ChuhalovaService chuhalovaService) {
     ...
     public ArrayList<Cathedra> getDepartmentsList() {
        ArrayList<Cathedra> departmentsList  = new ArrayList<Cathedra>();
...
//        }
    ...
    public void Show_Departments() {
        ArrayList<Cathedra> list = getDepartmentsList();
    ...
    public ArrayList<ScienceTheme> getTopicsList() {
        ArrayList<ScienceTheme> topicsList  = new ArrayList<ScienceTheme>();
//        Connection con = getConnection();
...
//        }
    ...
    public void Show_Topics() {
        ArrayList<ScienceTheme> list = getTopicsList();
    ...
    public ArrayList<Teacher> getProfsList() {
        ArrayList<Teacher> profsList  = new ArrayList<Teacher>();
//        Connection con = getConnection();
...
//        }
    ...
    public void Show_Profs() {
        ArrayList<Teacher> list = getProfsList();
    ...
    public boolean checkInputs()
    {
                ...
                Date cal = start_sc_st.getDate();
                String stDate = dateFormat.format(cal.getTime());
                Date cal2 = finish_sc_st.getDate();
        ...
        public ArrayList<ScientistJob> getScientistScienceTopicList()
    {
            ArrayList<ScientistJob> scientistScienceTopicList  = new ArrayList<ScientistJob>();
//            Connection con = getConnection();
...
//            }
    ...
    {
        ArrayList<ScientistJob> list = getScientistScienceTopicList();
    ...
    public ArrayList<ScientistJob> getProfessorScienceTopicList()
    {
            ArrayList<ScientistJob> profScienceTopicList  = new ArrayList<ScientistJob>();
//            Connection con = getConnection();
//            if (select_st.getSelectedItem() != null) {
//                ScienceTopic sst = (ScienceTopic) select_st.getSelectedItem();
...
//            }
    ...
    {
        ArrayList<ScientistJob> list = getProfessorScienceTopicList();
    ...
    private void initComponents() {
        ...
        start_sc_st = new JDateChooser();
        finish_sc_st = new JDateChooser();
